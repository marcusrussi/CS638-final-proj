...
PhysicalTraditional_LockManager::PhysicalTraditional_LockManager(uint32_t table_num) {
...
void PhysicalTraditional_LockManager::Setup(int worker_id) {
  keys_freelist[worker_id] = new Keys_Freelist();
  lockrequest_freelist[worker_id] = new Lockrequest_Freelist();
}

bool PhysicalTraditional_LockManager::Lock(LockUnit* lock_unit) {
...
void PhysicalTraditional_LockManager::Release(Txn* txn) {
...
void PhysicalTraditional_LockManager::Release(const TableKey table_key, Txn* txn) {
