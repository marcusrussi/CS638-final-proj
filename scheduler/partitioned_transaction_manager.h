...
#ifndef _DB_SCHEDULER_PARTITIONED_MANAGER_H_
#define _DB_SCHEDULER_PARTITIONED_MANAGER_H_
...
class Partitioned_TransactionManager {
 public:
  ...
  Partitioned_TransactionManager();
...
#endif  // _DB_SCHEDULER_PARTITIONED_MANAGER_H_
